...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=True, epsilon=1.0, alpha=0.6, min_alpha=0.2, gamma=0.0):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            self.epsilon = math.e ** (-0.02 * self.t)
    ...
    def get_maxQ(self, state):
        ...
        for key in self.Q[state].keys():
            if (maxQ is None) or (self.Q[state][key] > maxQ):
            ...
            if random.random() < self.epsilon:
                ...
                for key in self.Q[state].keys():
                    if self.Q[state][key] == maxQ:
                        action_maxq.append(key)
                action = random.choice(action_maxq)
        else:
            action = random.choice(self.valid_actions)
    ...
    def update(self):
        ...
        self.Q[state][action] = reward  # Update rewards in Q-table
...
def run():
    ...
    # display = False     #s - set to False to disable the GUI if PyGame is enabled
